<template>
  <div>
    ...
    <p>
      Hi! The website you are previewing is a demonstration for Mundana Jekyll theme, hosted on Github, made by
      <a
    ...
    <a target="_blank" class="btn btn-danger d-block" href="https://www.wowthemes.net/donate/">
